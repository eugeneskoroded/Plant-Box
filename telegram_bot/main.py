...
def get_text_messages(message):
    ...
    if message.text =="Вернуться в главное меню":
        ...
        info = "👋 Привет, я чат-бот помощник! Я могу проконсультировать тебя по вопросам, связанными с растениями. \n\n🗒 Напиши вопрос о растении, которое тебя интересует, а я постараюсь ответить.\n❗️ Учти, что мой ответ может занять от двух до нескольких минут.\n\n Примеры запросов:"
